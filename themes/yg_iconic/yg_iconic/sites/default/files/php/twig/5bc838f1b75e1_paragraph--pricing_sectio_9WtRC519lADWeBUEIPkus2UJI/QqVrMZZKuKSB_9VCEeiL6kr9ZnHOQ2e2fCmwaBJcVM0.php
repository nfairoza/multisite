...
class __TwigTemplate_efc5cf2ebfe6807bc4faac14af442945b8f16bf6edcedcdd63920a7fc5788957 extends Twig_Template
{
   ...
   <div class=\"container\">
      <div class=\"row wow fadeInUp\" >
         ";
        // line 12
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["content"] ?? null), "field_pricings", array()), "html", null, true));
        echo "
      </div>
   </div>      
</div>   ";
