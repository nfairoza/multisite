...
<div class=\"our_partners_area py-70 pt_banner_30\">
    <div class=\"container\">
        ...
        \t";
        // line 5
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["content"] ?? null), "field_client_logo", array()), "html", null, true));
        echo "
        </div>
    </div>
</div>      
